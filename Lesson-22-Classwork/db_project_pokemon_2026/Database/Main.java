...
class Main {
 ...
 public static void main(String[] args)throws IOException{
  ...
  void init() throws IOException{
    ...
    // connects the 3 tables together and selects the name, weight, height, type, and evolutionStage
    String sql = "SELECT Pokemon.name, Pokemon.weight, Pokemon.height, PokemonTypes.type, EvolutionStages.evolutionStage"
    + " FROM Pokemon"
